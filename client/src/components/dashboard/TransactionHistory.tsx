  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h2 className="text-2xl font-black text-white tracking-tight mb-2">Financial Ledger</h2>
        ...
        <div className="relative w-full md:w-80">
          ...
          <Input 
            ...
            className="pl-12 bg-white/5 border-white/10 rounded-xl h-12 text-sm"
            value={searchTerm}
        ...
        <Table>
          <TableHeader className="bg-white/5">
            <TableRow className="border-white/5 hover:bg-transparent">
              <TableHead className="text-muted-foreground font-black uppercase tracking-widest text-[10px] h-14 pl-8">Transaction Details</TableHead>
              <TableHead className="text-muted-foreground font-black uppercase tracking-widest text-[10px] h-14">Residence</TableHead>
              <TableHead className="text-muted-foreground font-black uppercase tracking-widest text-[10px] h-14">Amount</TableHead>
              <TableHead className="text-muted-foreground font-black uppercase tracking-widest text-[10px] h-14">Status</TableHead>
              <TableHead className="text-muted-foreground font-black uppercase tracking-widest text-[10px] h-14 text-right pr-8">Date</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {filteredTransactions.length > 0 ? filteredTransactions.map((trx) => (
              <TableRow key={trx.id} className="border-white/5 hover:bg-white/2 transition-colors">
                ...
                <TableCell>
                  <p className="text-white font-black tracking-tight">৳{trx.amount.toLocaleString()}</p>
                </TableCell>
                <TableCell>
                  <Badge 
